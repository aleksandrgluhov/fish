function fish_prompt --description 'Git aware custom fish prompt'
...
if not set -q __fish_classic_git_prompt_initialized
  set -qU fish_color_user
    or set -U fish_color_user -o white
...
end # if not set -q -g ___fish_classic_git_functions_defined

set -l color_cwd
set -l prefix
set -l suffix

# Define user dependent prompt suffix
#####################################################    
